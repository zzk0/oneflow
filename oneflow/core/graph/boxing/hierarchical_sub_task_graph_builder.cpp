...
Maybe<SubTskGphBuilderStatus> HierarchicalSubTskGphBuilder::Build(
  ...
  const Shape& reduced_in_parallel_hierarchy = *reduced_in_parallel_desc.hierarchy();
  const Shape& reduced_out_parallel_hierarchy = *reduced_out_parallel_desc.hierarchy();
