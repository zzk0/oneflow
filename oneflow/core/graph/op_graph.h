...
class OpEdge final : public Edge<OpNode, OpEdge> {
 ...
 private:
  ...
  std::shared_ptr<const std::vector<LogicalBlobId>> lbis_;
  std::shared_ptr<const HashMap<LogicalBlobId, std::string>> lbi2obn_;
  std::shared_ptr<const HashMap<LogicalBlobId, std::vector<std::string>>> lbi2ibns_;
