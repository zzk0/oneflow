...
struct ArithemeticIf<DeviceType::kGPU> {
  ...
  static void Pow(DeviceCtx* ctx, const int64_t n, const float power, const float* x, float* y);
  static void Pow(DeviceCtx* ctx, const int64_t n, const float power, const double* x, double* y);
